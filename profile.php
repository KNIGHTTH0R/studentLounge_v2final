...
<div class="container-fluid">
  ...
  <div class="col-md-12 profile-background">
    <div class="row">
     ...
     <div class="col-md-2">
      <p class="profile-username">@ <?php echo $row['user_username']; ?></p>
      <p class="profile-age">24</p>
      <p class="profile-city"><?php echo $row['user_location'];?></p>
    </div>
  </div>
</div>
          ...
          <div class="offset-md-1 col-md-7 profile-input">
            <div class="row">
              ...
              <div class="offset-md-2 col-md-4">
                <p class="profile-info2">
                  <?php echo $row['user_firstname']; echo " "; echo $row['user_lastname'];?></p>
                </div>
              </div>
            </div>
            ...
            <div class="offset-md-1 col-md-7 profile-input2">
              <div class="row">
                ...
                <div class="offset-md-1 col-md-4">
                  <p class="profile-info2"><?php echo $row['user_dateofbirth'];?></p>
                </div>
              </div>
            </div>
            ...
            <div class="offset-md-1 col-md-7 profile-input3">
              <div class="row">
                ...
                <div class="offset-md-1 col-md-4">
                  <p class="profile-info2"><?php echo $row['user_location'];?></p>
                </div>
              </div>
            </div>
            ...
            <div class="offset-md-1 col-md-7 profile-input2">
              <div class="row">
                ...
                <div class="offset-md-1 col-md-4">
                  <p class="profile-info2"><?php echo $row['user_gender'];?></p>
                </div>
              </div>
            </div>
            ...
            <div class="offset-md-1 col-md-7 profile-input3">
              <div class="row">
                ...
                <div class="offset-md-1 col-md-4">
                  <p class="profile-info2"><?php echo $row['user_type'];?></p>
                </div>
              </div>
            </div>
            ...
            <div class="offset-md-1 col-md-7 profile-input2">
              <div class="row">
                ...
                <div class="offset-md-1 col-md-4">
                  <p class="profile-info2"><?php echo $row['user_issmoker'];?></p>
                </div>
              </div>
            </div>
              ...
              <div class="offset-md-1 col-md-7 profile-input2">
                <div class="row">
                  ...
                  <div class="offset-md-2 col-md-4">
                    ...
                    <input class="edit-input" type="text" name="password"
              ...
              <div class="offset-md-1 col-md-7 profile-input2">
                <div class="row">
                  ...
                  <div class="offset-md-1 col-md-4">
                    ...
                    <input class="edit-input" type="text" name="area"
                    value="<?php echo $row['user_location']; ?>" />
